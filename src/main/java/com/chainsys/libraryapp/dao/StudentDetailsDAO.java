...
public interface StudentDetailsDAO {
	...
	public void save(@BindBean StudentDetails studentdetails) throws DbException;

	@SqlQuery("select * from student where std_id=?")
	@RegisterRowMapper(StudentDetailsRowMapper.class)
	public StudentDetails findById(int studentId) throws DbException;

	@SqlQuery("select * from student")
	@RegisterRowMapper(StudentDetailsRowMapper.class)
	public List<StudentDetails> findAll() throws DbException;
